...
export default async function LocaleLayout({children, params}: LocaleLayoutProps) {
  ...
  const calendeskContact = {
    href: "https://teodoro.calendesk.net/",
    label: tCommon("cta.calendesk"),
    ariaLabel: tCommon("cta.calendeskAria"),
  };
  ...
  return (
    <NextIntlClientProvider locale={locale} messages={messages}>
      ...
      <ActiveSectionProvider sectionIds={sectionIds} topOffset={144}>
        <div className="relative flex min-h-screen min-h-dvh flex-col bg-transparent text-accent-foreground dark:bg-transparent dark:text-surface lg:flex-row">
          <Sidebar
            locale={locale}
            navItems={navItems}
            ctas={ctas}
      ...
      <FloatingActions calendeskContact={calendeskContact} whatsappContact={whatsappContact} />
      <CookieBanner />
      <ConsentPreferences />
